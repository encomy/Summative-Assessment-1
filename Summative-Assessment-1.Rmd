...
***
Would the grand prize of ₱50 million cover all the expenses or it would simply incur a massive loss on the bettor?
...
For Ultra Lotto 6/58, there are 40,475,358 possible combinations. Since 1 ticket equals 1 combination, and 1 ticket costs ₱20, the bettor would need to pay 40,475,358 x ₱20, or ₱809,507,160, to cover all combinations. The grand price, though, is just ₱50 million, which is less than the amount the bettor would wager. Therefore, placing a bet on every single possible combination in the Ultra Lotto 6/58 will result in a huge loss for the bettor.
