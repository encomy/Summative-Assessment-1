...
***
|           At first glance, it seems as though no matter what door you pick you'll only have a 1/3 chance of winning the car. Psychologically speaking, it will also hurt more to lose something we might think we had the "chance" of getting but not holding for it. It will be easier to admit that we just truly lost staying our ground than to lose and feel as if we missed our chance by not trusting ourselves. It might feel a bit counter intuitive, but probability says otherwise.Yet again, all doors have a 1/3 chance of containing the car, including the one you've picked. However, there is a 2/3 chance that the car is behind the other two doors. This fact became a real game changer when Monty opens the other door which contains a goat. You might think that the chances are now 50/50 but as mentioned earlier, it was always a 1/3 and 2/3 chance between the two. In fact we can also prove this by listing the different combinations of outcomes for this problem; the number of times a switch wins is higher. This concept works because Monty helped by opening a wrong door. Therefore, the wiser choice is to take the switch.
